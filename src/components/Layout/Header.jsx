...
const Header = ({sideBarCollapsed, onToggleSidebar}) => {
  return (
    <div className="w-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b
    border-slate-200/50 dark:border-slate-700/50 px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          hover:bg-slate-100 dark:hover:bg-slate-800 transtion-colors"
          ...
          <div className="relative">
            <Search className="w-4 h-4 absolute left-3 top-1/2 transform -translate-y-1/2
              ...
              <input 
                 ...
                 focuse:ring-blue-500 focus:border-transparent transtion-all"
              />
        ...
        <div className="flex items-center space-x-3">
            ...
            <button className="relative p-2.5 rounded-xl text-slate-600 dark:text-slate-300
             hover:bg-slate-100 dark:hover:bg-slate-800 transtition-colors">
              <Bell className="w-5 h-5"/>
              <span className="absolute -top-1 w-5 h-5 bg-red-500 text-white text-x5
