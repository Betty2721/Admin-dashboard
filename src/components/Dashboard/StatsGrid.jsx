import { ArrowRight, ShoppingCart, DollarSign, Users, Eye, ArrowUpRight, ArrowDownRight } from 'lucide-react'
     ...
     {stats.map((stats, index) => {
       ...
       group" key={index}>
          <div className="flex items-start justify-between">
             ...
             <div 
                className={`p-3 rounded-xl ${stats.bgcolor} group-hover:scale-110 transition-all 
                  duration-200`}>
